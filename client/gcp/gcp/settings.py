...
SECRET_KEY = '$nj(o9v4rl%*a)k^$a3rpuo^lje11+!p4p6!04jd4&!*#a@+h@'
...
MIDDLEWARE = [
    ...
    'review.middleware.Test',
    'review.middleware.Test1'
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(os.path.dirname(os.path.dirname(__file__)), "templates", "static")]